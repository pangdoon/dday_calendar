...
const modalMessageList = [
  { "number": 1, "message": "진영이와 함께하는 1일 시작합니다." },
  { "number": 2, "message": "오늘도 배고프다구요..? 저도 압니다.. 저도 배고파요" },
  { "number": 3, "message": "공부는 잘하고 계신가요..? 열심히 하고있죠?" },
  { "number": 4, "message": "SSAFY에서 많은 것을 배우고 갑시다." },
  { "number": 5, "message": "공부를 열심히 해보자구요, 할 수 있습니다." },
